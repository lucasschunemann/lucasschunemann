...
No momento divido o tempo entre dois lugares. Sou co-fundador e CPO do [neth!](https://somosneth.com), uma plataforma brasileira de conteúdo e serviços em saúde e bem-estar, cuido de direção de produto, prototipação no Figma, validação de UX e da gestão do desenvolvimento. E em paralelo trabalho remoto full-time como designer, mexendo com produtos B2B, pesquisa, jornadas e interface na [Área Central](https://www.areacentral.com.br).
